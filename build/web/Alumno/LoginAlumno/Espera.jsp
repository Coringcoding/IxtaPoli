    ...
    <body>        
        ...
        <div class="container">
            <div class="row">
                <div class="col l12">
                    <div class="card">
                        <div class="degradado card-content white-text">
                            <span class="card-title"><h1 class="center-align white-text">En Espera</h1></span>
                            <p class="center-align">En estos momentos su solicitud esta en espera de ser revisada
                            y aceptada por alguno de los Administradores de IxtaPoli. Gracias por su
                            comprensión.</p>
